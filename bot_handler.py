...
Как мною пользоваться:
    ...
    Выбираешь, что с ним делать:
        ...
        Добавить:
            ...
            Вводим ключ (к примеру pin карты, чтобы не забыть), чтобы закодировать пароль и никто не смог его получить
        Удалить:
            Просто удаляет данный пароль.
''')
